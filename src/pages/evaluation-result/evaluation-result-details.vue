...
const standardList = [
  {
    id: 1,
    primaryStandard:
      '教学常规（A系处打分）系处打分处打分处打分处打分处打分处打分处打分处打分处打分',
    score: 20,
    children: [
      {
        id: 11,
  ...
  {
    id: 2,
    primaryStandard: '工作态度(B)系处打分',
    score: 20,
    children: [
      {
        id: 21,
        secondaryStandard: '工作态度',
        scoringBasis:
          '每一项中，完成相当出色20分，良好 15分，一般10分，差0～5分。 此项由系主任和教研组长组成评分小组，根据实际情况打分。此栏分数为这五项分数的总和。',
        children: [
          {
            id: 221,
            referenceStandard: '认真完成学校、系处、教研组布置的各项任务'
          },
          {
            id: 222,
            referenceStandard:
              '积极参加学校、系处、教研组等召开的各类会议及组织的各类大型活动'
          },
          {
            id: 223,
            referenceStandard:
              '教学态度亲切，关心爱护学生。参考学生座谈会记录和常规检查情况'
          },
          {
            id: 224,
            referenceStandard:
              '教学过程中，布置作业适量，批改认真，并且能给予学生及时反馈'
          },
          {
            id: 225,
            referenceStandard:
              '书写教案认真，听课笔记书写仔细，编写试卷合理。根据常规检查情况给分'
          }
        ]
      }
    ]
...
<template>
  <view class="standard">
    <u-navbar
      ...
      :autoBack="true"
    />
    <view class="standard-title">孙雷老师得分详情</view>
